...
Definition rep_ok_enq : forall (A : Type) (q : queue A), rep_ok q -> forall (x : A), rep_ok (enq x q) := rep_ok_enq.
Definition rep_ok_deq: forall (A : Type) (q : queue A), rep_ok q -> rep_ok (deq q) := rep_ok_deq.
